...
### Run the workflow
Once everything is set up, [third-party accounts](3rdPartyAccounts.md) are configured, and the [configuration files](setup.md) are customized, you can run the CLUES workflow using Snakemake:
