...
You can find an overview of the main data sources and datasets included in the default workflow [here](https://github.com/BIH-DMBS/CLUES/tree/main/docs/data_list.md), which can help users identify the relevant licenses to consult as needed.  
