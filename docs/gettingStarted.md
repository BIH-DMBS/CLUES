...
### Run the workflow
Once everything is set up, the [Third Party Accounts](3rdPartyAccounts.md) are created and the [Configuration Files](setup.md) are customized, you can run the CLUES workflow using Snakemake:
