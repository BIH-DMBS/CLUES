...
A summary of the main data sources and the datasets retrieved under the default workflow configuration is available in this [Table](datalist.md). This overview helps clarify the origin and scope of the data and highlights the importance of proper data governance throughout the research process.
