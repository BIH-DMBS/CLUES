...
- To learn how to use the CLUES framework, follow the [User Guide](UserGuide.md) and explore the [Applied Examples](https://github.com/BIH-DMBS/CLUES/blob/main/docs/Examples.md).  
